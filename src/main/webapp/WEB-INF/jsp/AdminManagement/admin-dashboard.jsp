                                    ...
                                    <div style="margin-top:18px; padding-top:16px; border-top:2px dashed var(--border);">
                                        ...
                                        <form action="/admin/add-image" method="POST" enctype="multipart/form-data"
                                            ...
                                            <div style="flex:1; min-width:200px;">
                                                <label style="font-size:0.78rem; font-weight:600; display:block; margin-bottom:4px;">Upload Image</label>
                                                <input type="file" name="image_file" accept="image/*" required
                                                       style="width:100%; padding:7px 10px; border:1px solid #cbd5e1; border-radius:6px; font-family:inherit; font-size:0.85rem; background:white;">
                                            </div>
