...
<head>
    <meta charset="UTF-8">
    <title>Add Seller | PropertyHub</title>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .card-title span { background:linear-gradient(135deg,#10b981,#34d399);
...
<body>
<div class="card">
    <div class="card-title">Create <span>Seller Account</span></div>
    <div class="card-sub">Component 02 — Seller Management &nbsp;|&nbsp; Add a new seller to the system</div>

    <c:if test="${not empty errorMsg}">
        <div class="alert-error">✗ ${errorMsg}</div>
    </c:if>

    <form method="post" action="/sellers/save">
        <div class="form-group">
            <label>First Name <span class="required">*</span></label>
            <input type="text" name="firstName" required placeholder="e.g. Nimal" maxlength="50">
        </div>
        <div class="form-group">
            <label>Last Name <span class="required">*</span></label>
            <input type="text" name="lastName" required placeholder="e.g. Silva" maxlength="50">
        </div>
        <div class="form-group">
            <label>Email Address <span class="required">*</span></label>
            <input type="email" name="email" required placeholder="seller@example.com" maxlength="100">
        </div>
        <div class="form-group">
        ...
        <div class="btn-row">
            ...
            <a href="/sellers" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
</body>
