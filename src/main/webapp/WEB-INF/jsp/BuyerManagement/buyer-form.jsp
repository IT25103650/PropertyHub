...
<head>
  <meta charset="UTF-8">
  <title>Add Buyer | PropertyHub</title>
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .card-title span { background:linear-gradient(135deg,#6366f1,#8b5cf6);
...
<body>
<div class="card">
  <div class="card-title">Create <span>Buyer Account</span></div>
  <div class="card-sub">Component 01 — Buyer Management &nbsp;|&nbsp; Add a new buyer to the system</div>

  <c:if test="${not empty errorMsg}">
    <div class="alert alert-error">✗ ${errorMsg}</div>
  </c:if>

  <form method="post" action="/buyers/save">
    <div class="form-group">
      <label>First Name <span class="required">*</span></label>
      <input type="text" name="firstName" required placeholder="e.g. Kamal" maxlength="50">
    </div>
    <div class="form-group">
      <label>Last Name <span class="required">*</span></label>
      <input type="text" name="lastName" required placeholder="e.g. Perera" maxlength="50">
    </div>
    <div class="form-group">
      <label>Email Address <span class="required">*</span></label>
      <input type="email" name="email" required placeholder="buyer@example.com" maxlength="100">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="tel" name="phone" placeholder="+94 7X XXX XXXX" maxlength="20">
      <div class="hint">Optional — used for viewing appointment notifications</div>
    </div>
