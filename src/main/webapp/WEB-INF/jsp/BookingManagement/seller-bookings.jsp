...
<head>
    <meta charset="UTF-8">
    <title>Seller Bookings | PropertyHub</title>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .title { font-size:1.8rem; font-weight:700; color:#10b981; }
...
<div class="container">
    <div class="header">
        <div>
            <div class="title">Viewing Requests for My Properties</div>
            <div class="subtitle">Component 04 — Manage buyer viewing appointments</div>
        </div>
        ...
        <c:choose>
            <c:when test="${empty bookings}">
                <div class="empty-state">
                    ...
                    <p>No viewing requests received yet.</p>
                </div>
            </c:when>
            <c:otherwise>
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a href="/properties/${b.property_id}" style="color:#10b981;font-weight:500;">
                                    ${b.property_title}
                                </a><br>
                                <span style="font-size:.8rem;color:#64748b;">${b.location}</span>
                            </td>
                            <td>
                                <strong>${b.buyer_first_name} ${b.buyer_last_name}</strong><br>
                                <span style="font-size:.8rem;color:#94a3b8;">${b.buyer_phone} &nbsp;|&nbsp; ${b.buyer_email}</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <div style="display:flex;gap:6px;flex-wrap:wrap;">
                                    ...
                                    <c:if test="${b.status == 'pending'}">
                                        <a href="/bookings/approve/${b.booking_id}" class="btn btn-success" style="padding:6px 12px;font-size:.8rem;">Approve</a>
                                        <a href="/bookings/reject/${b.booking_id}" class="btn btn-danger" style="padding:6px 12px;font-size:.8rem;">Reject</a>
                                    </c:if>
                                    <c:if test="${b.status == 'confirmed'}">
                                        <a href="/bookings/complete/${b.booking_id}" class="btn btn-primary" style="padding:6px 12px;font-size:.8rem;">Complete</a>
                                    </c:if>
                                </div>
                            </td>
                        </tr>
